...
function brewsite_load_scripts(){
    wp_enqueue_script( 'brewsite', get_template_directory_uri() . '/js/brewsite.js', array('jquery'), '1.0.0', true );
}

add_action( 'wp_enqueue_scripts', 'brewsite_load_scripts' );
